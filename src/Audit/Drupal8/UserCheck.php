...
namespace Drutiny\Plugin\Fubarhouse\Drupal8\Audit;
 ...
 * )
 */
class UserCheck extends Audit implements RemediableInterface {
  ...
  public function audit(Sandbox $sandbox) {
    ...
    $uid = (int) $sandbox->getParameter('uid');
